...
READ_HOME_DATA_SCOPE = "read_own_home_data"
READ_PROFILE_DATA_SCOPE = "read_own_profile"
EMAIL_SCOPE = "email"
...
USER_SCOPES = (
    ...
    CREATE_OWN_APPOINTMENTS_SCOPE,
    READ_OWN_APPOINTMENTS_SCOPE,
    READ_LOCATIONS_SCOPE,
    READ_HOME_DATA_SCOPE,
    READ_PROFILE_DATA_SCOPE,
    EMAIL_SCOPE,
    PROFILE_SCOPE,
)

# API Metadata
API_TITLE = "QMS End User API"
API_SUMMARY = "API for QMS End User App"
API_DESCRIPTION = "The API for the QMS End User Application."
API_VERSION = "1.0.0"
...
AUTH_APPLICATION_ENV_NAME = "AUTH_APPLICATION"
...
ADMIN_CLIENT_ID_ENV_NAME = "ADMIN_CLIENT_ID"
ADMIN_CLIENT_SECRET_ENV_NAME = "ADMIN_CLIENT_SECRET"
