...
def validate_token(expected_scope: str):
    ...
    def _validate(authorization: str = Header(..., convert_underscores=False),):
        ...
        Raises:
            ...
            HTTPException: Authorization error when token is invalid.
        ...
        try:
            response = api.validate_token(authorization, expected_scope)
