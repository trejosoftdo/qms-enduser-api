...
from app.auth.constants import LOGIN_ROUTE_PATH, REGISTER_USER_ROUTE_PATH, TOKEN_REFRESH_PATH
...
class RouterTest(unittest.TestCase):
    ...
    def test_authorize_device(self, auth_device_mock, validate_token_mock):
        ...
        response = self.client.get(
            f"{constants.AUTH_ROUTE_PREFIX}{LOGIN_ROUTE_PATH}",
    ...
    def test_get_auth_tokens(self, get_auth_tokens_mock, validate_token_mock):
        ...
        response = self.client.post(
            f"{constants.AUTH_ROUTE_PREFIX}{REGISTER_USER_ROUTE_PATH}",
            headers=self.headers,
            json=payload.dict(),
        )
